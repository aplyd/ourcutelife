  ...
  return (
    <View className="flex-1 bg-[#fff8f1] px-6 pt-16 gap-6">
      ...
      <View className="rounded-3xl bg-[#2f211c] p-5 gap-3">
        ...
        <Text className="text-2xl font-bold leading-8 text-[#fff8f1]">
          What’s one small thing your partner did recently that made life easier?
        </Text>
        <Text className="text-[#d8c2b4]">
          Prompt answers will later feed weekly briefs and monthly reviews.
        </Text>
      </View>
